...
<section className="h-screen flex">
    <section className="h-screen flex">
  <div className="max-w-6xl mx-auto w-full px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-8">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xl text-neutral-700 font-medium underline-animation">
          Software Developer
        </p>
      </div>

      <p className="text-neutral-700 max-w-lg leading-relaxed text-lg">
    ...
    <div className="flex justify-end items-center">
      <img
        src="/hero.jpeg"
        alt="Anirudh"
        className="h-[80vh] object-cover border-2 border-neutral-900
