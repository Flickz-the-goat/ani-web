    ...
    <nav className="fixed w-full z-10 py-4">
      <AnimatePresence>
        <motion.div
          ...
          className="flex justify-between py-2 px-5 max-w-6xl mx-auto backdrop-blur-2xl bg-transparent border border-gray-800 hard-shadow"
        >
          <div className="">
            <Link
              href={"/"}
              className="font-extrabold italic text-2xl text-orange-500 underline-animation bg-transparent"
            >
              flickz
            </Link>
          </div>
